  ...
  describe('.publishRecipientCreatedEvent', () => {
    ...
    beforeEach(() => {
      sinon.stub(Events, 'buildRecipientCreatedEvent')
        ...
        .withArgs({ listId, userId, recipient: invalidRecipient, subscriptionOrigin }).rejects(new Error('Ooops'));
    });
  ...
  describe('.publishRecipientUpdatedEvent', () => {
    ...
    beforeEach(() => {
      sinon.stub(Events, 'buildRecipientUpdatedEvent')
        ...
        .withArgs({ listId, userId, id: recipientId, data: invalidPayload }).rejects(new Error('Ooops'));
    });
  ...
  describe('.publishRecipientDeletedEvent', () => {
    ...
    beforeEach(() => {
      sinon.stub(Events, 'buildRecipientDeleteEvent')
        ...
        .withArgs({ listId, userId }).rejects(new Error('Ooops'));
    });
